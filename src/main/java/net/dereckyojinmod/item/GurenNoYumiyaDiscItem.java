...
public class GurenNoYumiyaDiscItem extends DerecKyojinmodModElements.ModElement {
	@ObjectHolder("derec_kyojinmod:guren_no_yumiya_disc")
	public static final Item block = null;
	public GurenNoYumiyaDiscItem(DerecKyojinmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, DerecKyojinmodModElements.sounds.get(new ResourceLocation("derec_kyojinmod:gurennoyumiya")),
					new Item.Properties().group(AttackOnTitanMusicItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("guren_no_yumiya_disc");
		}
